...
export namespace Prisma {
  ...
  */
  ...
  export type UserSelect = {
    ...
    createdAt?: boolean
    updatedAt?: boolean
    memory?: boolean | User$memoryArgs
  ...
  export type UserGetPayload<S extends boolean | null | undefined | UserArgs> =
    ...
    [P in TruthyKeys<S['include']>]:
        P extends 'memory' ? Array < MemoryGetPayload<S['include'][P]>>  :
        P extends '_count' ? UserCountOutputTypeGetPayload<S['include'][P]> :  never
  } 
    : S extends { select: any } & (UserArgs | UserFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'memory' ? Array < MemoryGetPayload<S['select'][P]>>  :
  ...
  export class Prisma__UserClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    ...
    memory<T extends User$memoryArgs= {}>(args?: Subset<T, User$memoryArgs>): Prisma.PrismaPromise<Array<MemoryGetPayload<T>>| Null>;
  ...
  export interface MemoryDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    createMany<T extends MemoryCreateManyArgs>(
      args?: SelectSubset<T, MemoryCreateManyArgs>
    ): Prisma.PrismaPromise<BatchPayload>
  ...
  export type MemoryCreateManyArgs = {
     ...
     */
    data: Enumerable<MemoryCreateManyInput>
    skipDuplicates?: boolean
  }
  ...
  export type MemoryCreateManyUserInputEnvelope = {
    data: Enumerable<MemoryCreateManyUserInput>
    skipDuplicates?: boolean
  }
  ...
  export type MemoryUpdateManyWithWhereWithoutUserInput = {
    ...
    data: XOR<MemoryUpdateManyMutationInput, MemoryUncheckedUpdateManyWithoutMemoryInput>
  }
  ...
  export type MemoryUncheckedUpdateManyWithoutMemoryInput = {
    id?: IntFieldUpdateOperationsInput | number
    title?: StringFieldUpdateOperationsInput | string
    content?: StringFieldUpdateOperationsInput | string
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
